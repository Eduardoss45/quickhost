...
const CadastroAcomodacoes = React.lazy(() => import('./pages/CadastroAcomodacoes'));
const Configuracoes = React.lazy(() => import('./pages/Configuracoes'));
const CardCancelarReservas = React.lazy(() => import('./components/CardCancelarReservas'));
const Pagamento = React.lazy(() => import('./pages/Pagamento'));
const FormPagamento = React.lazy(() => import('./components/FormPagamento'));
const FinalizacaoReservas = React.lazy(() => import('./pages/FinalizacaoReservas'));
const InformacoesAcomodacao = React.lazy(() => import('./pages/InformacoesAcomodacao'));
    ...
    <>
      ...
      {loading ? (
        ...
        <Routes>
          <Route
            path="/"
            element={<Home isAuthenticated={isAuthenticated} accommodations={accommodations} />}
          />
          ...
          <Route
            path="/hospedar"
            element={<Hospedar accommodationData={userData?.registered_accommodations || null} />}
          />
      ...
      {location.pathname !== '/entrar' &&
        ...
        location.pathname !== '/acomodacoes/nova' && (
          <Footer
            className={`App ${
              location.pathname !== '/entrar' && location.pathname !== '/cadastro' ? 'no-fixed' : ''
            }`}
          />
        )}
    </>
