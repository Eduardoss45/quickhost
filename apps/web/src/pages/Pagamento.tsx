  ...
  return (
    <div className="pagamento-card">
      <div className="card-primario">
        ...
        <div>
          <h3>Sua reserva</h3>
          <p>{formatDateRange(formData?.check_in_date, formData?.check_out_date)}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            O reembolso só será possível caso o cancelamento seja efetuado 7 dias antes da reserva.
            Após o prazo será cobrado uma taxa de 10% do preço da acomodação.
          </p>
