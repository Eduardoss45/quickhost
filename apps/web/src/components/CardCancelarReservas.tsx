...
import './css/CardCancelarReservas.css';
    ...
    <div className="card-cancelar">
        ...
        <div className="details-container">
          <div>
            <div className="title-container">
              <h2 className="title">{accommodationData?.title || 'Não informado'}</h2>
          ...
          <div>
            <div>
              ...
              <p className="info">Endereço: {accommodationData?.address || 'Não informado'}</p>
            </div>
            <div>
              <span>
      ...
      <div className="action-container">
        <div className="button-group">
          ...
          <button onClick={handleCancelarReserva} className="secondary-button" disabled={loading}>
