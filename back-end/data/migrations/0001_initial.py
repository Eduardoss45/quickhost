    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_accommodations', models.JSONField(blank=True, default=list)),
                ('registered_reviews', models.JSONField(blank=True, default=list)),
                ('registered_bookings', models.JSONField(blank=True, default=list)),
                ('registered_accommodations_bookings', models.JSONField(blank=True, default=list)),
                ('registered_favorite_property', models.JSONField(blank=True, default=list)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consecutive_days_limit', models.IntegerField(blank=True, help_text='Número de dias consecutivos permitido.', null=True)),
                ...
                ('registered_user_bookings', models.JSONField(blank=True, default=list)),
                ('registered_bookings', models.JSONField(blank=True, default=list)),
                ...
                ('bank_account', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.bankdetails')),
