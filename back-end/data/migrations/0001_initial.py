    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_accommodation_bookings', models.ManyToManyField(blank=True, to='data.booking')),
                ('registered_users', models.ManyToManyField(blank=True, related_name='registered_accommodations', to='data.booking')),
            ],
        ),
        migrations.AddField(
            model_name='booking',
